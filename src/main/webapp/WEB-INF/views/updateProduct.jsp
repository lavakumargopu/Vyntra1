...
<%@ page import="java.sql.*, com.vyntra.beans.*,com.vyntra.dao.*" %>    
        ...
        <form action="./UpdateProductSrv" method="post" >
          ...
          <table border="0">
            ...
            <tr><td>Product Type&nbsp;</td><td><select name="type" style="font-size: 15px;font-weight: normal; width:80%" value="<%=product.getProdType() %>">
            				<option value="1">dress1</option>
            				<option value="2">dress2</option>
            				<option value="3">dress3</option>
            				<option value="4">dress4</option>
            				<option value="5">dress5</option>
            				<option value="6">dress6</option>
					<option value="7">dress7</option>
            				<option value="8">dress8</option>
            				<option value="9">dress9</option>
            				<option value="10">dress10</option>
            				<option value="other">Some Other Dresses</option>
            							</select></td></tr>
            <tr><td><br></td><td><br></td></tr>            
